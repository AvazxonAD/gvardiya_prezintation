/* Inline SVG ikonkalar — tashqi kutubxona yo'q (offline ishlashi uchun) */
...
const ICON_PATHS = {
  ...
  "folder-x":
    '<path d="M4 20a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2Z"/><path d="m9.5 10.5 5 5"/><path d="m14.5 10.5-5 5"/>',
  ...
  "bar-chart":
    '<path d="M3 3v18h18"/><path d="M8 17V9"/><path d="M13 17V5"/><path d="M18 17v-5"/>',
  ...
  unlink:
    '<path d="m18.84 12.25 1.72-1.71a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="m5.17 11.75-1.71 1.71a5 5 0 0 0 7.07 7.07l1.71-1.71"/><path d="m2 2 20 20"/>',
...
/* width/height="1em" — CSS o'lchami berilmagan joyda ham ikonka shishib ketmasligi
   uchun. Aniq o'lcham beruvchi CSS qoidalari bu atributlardan ustun turadi. */
